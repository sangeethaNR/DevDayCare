...
export default function Profile() {
  ...
  const profile = data?.getStudentProfile;
  console.log(profile, "infopage");
  return (
          ...
          <Grid container spacing={4}>
              ...
              >
                ...
                <CardContent sx={{ flexGrow: 1 }}>
                  ...
                  >
                    ...
                    Birthdate:{" "}
                    {new Date(
                      Number(profile?.dateOfBirth)
                    ).toLocaleDateString()}
                    <br />
                    Allergy: {profile?.allergy?.map((i) => i)}
                    <br />
                    Potty Trained: {profile?.isPottyTrained ? "Yes" : "No"}
                    <br />
                    Class: Shark
                  </Typography>
                </CardContent>
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                ...
                />
                {profile?.emergencyContact?.map(i => (
                   <CardContent sx={{ flexGrow: 1 }}>
                   <Typography
                     gutterBottom
                     variant="h5"
